...
@section('content')
    ...
    <form action="{{ route('razen-style.admin.tim.update',['id' => $tim->id]) }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-body">
                <div class="row mb-3">
                ...
                <div class="mb-3 position-relative form-group">
                    ...
                    <textarea name="deskripsi" id="deskripsi" rows="5" class="form-control" required>{{$tim->deskripsi}}</textarea>
                </div>
                <div class="mb-3 position-relative form-group">
                ...
                <div class="mb-3 position-relative form-group">
                    ...
                    <input type="file" class="dropify" name="foto" data-height="150" data-allowed-file-extensions="png jpg jpeg webp" data-show-errors="true" data-default-file="{{ asset('images/razen-style/tim/'.$tim->foto) }}" required>
                </div>
            </div>
        </div>
        @if ($pivot['status'] == 'ada')
