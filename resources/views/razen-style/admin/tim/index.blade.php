...
@section('content')
    ...
    <div class="row mb-3">
        <div class="col-12" style="text-align:right">
            <a class="btn btn-outline-primary waves-effect waves-light mr-2 item_create" href="{{ route('razen-style.admin.tim.create') }}"><i class="fas fa-plus"></i></a>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function(){
            var dataTables = $('#tim_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('razen-style.admin.tim.index') }}"
                },
                columns: [
                    {
                        data: 'DT_RowIndex',
        ...
        $('#ok_button').click(function(){
            var url = "{{ route('razen-style.admin.tim.destroy', ['id' => ":user_id"]) }}";
