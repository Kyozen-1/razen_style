...
@section('title', 'Razen Style | Landing Page | Kontak')
...
@section('content')
    ...
    <div class="page-title-container">
        ...
        <div class="col-12 col-md-7">
            <h1 class="mb-0 pb-0 display-4" id="title">Kontak</h1>
            <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
                <ul class="breadcrumb pt-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('razen-style.landing-page.kontak.index') }}">Kontak</a></li>
                </ul>
            </nav>
        </div>
        <!-- Title End -->
        ...
        <div class="card-body">
            <div class="row mb-3">
                ...
                <div class="col-6 mb-3" style="text-align: right;">
                    <a href="{{ route('kontak') }}#heading-banner-area" class="btn btn-icon waves-effect waves-light btn-secondary" target="blank"><i class="fas fa-pager"></i> Preview</a>
                </div>
                <div class="col-12">
            ...
            {{-- Form Start --}}
            <form action="{{ route('razen-style.landing-page.kontak.store.section-1') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row mb-3">
                    <div class="col-12">
