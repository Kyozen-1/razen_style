                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="about-photo">
                            <img src="{{ asset('hurst/img/bg/about.png') }}" alt="" />
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="single-member text-center bg-white mt-25">
                            <img src="{{ asset('hurst/img/team/1.png') }}" alt="" />
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-member text-center bg-white mt-25">
                            <img src="{{ asset('hurst/img/team/2.png') }}" alt="" />
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-member text-center bg-white mt-25">
                            <img src="{{ asset('hurst/img/team/3.png') }}" alt="" />
                            <h3 class="text-uppercase mt-20">Nancy holland</h3>
