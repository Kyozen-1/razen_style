                                    ...
                                    <div class="all-cart-product clearfix">
                                        <div class="single-cart clearfix">
                                            <div class="cart-photo">
                                                <a href="#"><img src="{{ asset('hurst/img/cart/1.jpg') }}" alt="" /></a>
                                            </div>
                                            <div class="cart-info">
                                        ...
                                        <div class="single-cart clearfix">
                                            <div class="cart-photo">
                                                <a href="#"><img src="{{ asset('hurst/img/cart/2.jpg') }}" alt="" /></a>
                                            </div>
                                            <div class="cart-info">
                                                <h5><a href="#">dummy product name</a></h5>
                            ...
                            <div class="table-cell">
                                ...
                                <div class="full-width">
                                    <div class="mega-menu-img">
                                        <a href="single-product.html"><img src="{{ asset('hurst/img/megamenu/1.jpg') }}" alt="" /></a>
                                    </div>
                                </div>
                                <div class="pb-80"></div>
                            </div>
