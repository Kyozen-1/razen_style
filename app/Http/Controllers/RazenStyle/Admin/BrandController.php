...
class BrandController extends Controller
{
        ...
        if(request()->ajax())
        {
            ...
            return DataTables::of($data)
                ...
                ->editColumn('gambar', function($data) {
                    return '<img src="'.asset('images/razen-style/brand/'.$data->gambar).'" style="height:5rem;">';
                })
                ->rawColumns(['aksi', 'gambar'])
                ->make(true);
        }
        return view('razen-style.admin.brand.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        $gambarSize = public_path('images/razen-style/brand/'.$gambarName);
        $gambar->save($gambarSize, 60);

        $brand = new Brand;
        $brand->nama = $request->nama;
        $brand->gambar = $gambarName;
        $brand->save();
    ...
    {
        return response()->json(['result' => Brand::find($id)]);
    }
    ...
    public function update(Request $request)
    {
        ...
        if($request->gambar)
        {
            File::delete(public_path('images/razen-style/brand/'.$brand->gambar));
        ...
        return response()->json(['success' => 'Berhasil Merubah Brand']);
    }
